...
text_tokenizer = PhonemeBpeTokenizer(tokenizer_path="C:\\Users\\jakub\\Desktop\\pygpt\\VALL_E_X\\utils\\g2p\\bpe_69.json")
...
def generate_audio(text, prompt=None, language='auto', accent='no-accent'):
    ...
    if prompt is not None:
        ...
        if not os.path.exists(prompt_path):
            prompt_path = "C:\\Users\\jakub\\Desktop\\pygpt\\VALL_E_X\\presets\\" + prompt + ".npz"
        if not os.path.exists(prompt_path):
